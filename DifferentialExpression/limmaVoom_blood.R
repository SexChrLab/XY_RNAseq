...
#-----------
counts <- read.delim("blood_std_counts.tsv", header=FALSE, sep="\t")
...
pheno <- read.csv("blood_pheno.csv", header=TRUE, sep=",")
...
png(filename ="figures/CLUSTER_SEX_GENOME_ALIGNER_dim23_blood.png",width=6,height=3,units="in",res=1200)
par(mfrow=c(1,3))
col.sex <- sex
...
#lcpm <- cpm(dge, log=TRUE)
png(filename ="figures/CLUSTER_SEX_GENOME_ALIGNER_dim12_blood.png",width=6,height=3,units="in",res=1200)
par(mfrow=c(1,3))
col.sex <- sex
levels(col.sex) <-  brewer.pal(nlevels(col.sex), "Set1")
col.sex <- as.character(col.sex)
...
#write.table(ngenes_MvsF_def_STAR_vebayesfit, file="genelists/genes_MvsF_def_STAR_vebayesfit_blood.txt",sep="\t")
#write.table(ngenes_MvsF_def_HI_vebayesfit, file="genelists/genes_MvsF_def_HI_vebayesfit_blood.txt",sep="\t")
#write.table(ngenes_MvsF_SS_STAR_vebayesfit, file="genelists/genes_MvsF_SS_STAR_vebayesfit_blood.txt",sep="\t")
#write.table(ngenes_MvsF_SS_HI_vebayesfit, file="genelists/genes_MvsF_SS_HI_vebayesfit_blood.txt",sep="\t")
#write.table(ngenes_FvsF_def_SS_STAR_vebayesfit, file="genelists/genes_FvsF_def_SS_STAR_vebayesfit_blood.txt",sep="\t")
#write.table(ngenes_FvsF_def_SS_HISAT_vebayesfit, file="genelists/genes_FvsF_def_SS_HISAT_vebayesfit_blood.txt",sep="\t")
#write.table(ngenes_MvsM_def_SS_STAR_vebayesfit, file="genelists/genes_MvsM_def_SS_STAR_vebayesfit_blood.txt",sep="\t")
#write.table(ngenes_MvsM_def_SS_HISAT_vebayesfit, file="genelists/genes_MvsM_def_SS_HISAT_vebayesfit_blood.txt",sep="\t")
...
# Writing results into a comma-delimited file
#write.table(MvsF_def_STAR_vebayesfit, file="genelists/genes_MvsF_def_STAR_vebayesfit_lfc1_blood.txt",sep="\t")
#write.table(MvsF_def_HI_vebayesfit, file="genelists/genes_MvsF_def_HI_vebayesfit_lfc1_blood.txt",sep="\t")
#write.table(MvsF_SS_STAR_vebayesfit, file="genelists/genes_MvsF_SS_STAR_vebayesfit_lfc1_blood.txt",sep="\t")
#write.table(MvsF_SS_HI_vebayesfit, file="genelists/genes_MvsF_SS_HI_vebayesfit_lfc1_blood.txt",sep="\t")
#write.table(FvsF_def_SS_STAR_vebayesfit, file="genelists/genes_FvsF_def_SS_STAR_vebayesfit_lfc1_blood.txt",sep="\t")
#write.table(FvsF_def_SS_HISAT_vebayesfit, file="genelists/genes_FvsF_def_SS_HISAT_vebayesfit_lfc1_blood.txt",sep="\t")
#write.table(MvsM_def_SS_STAR_vebayesfit, file="genelists/genes_MvsM_def_SS_STAR_vebayesfit_lfc1_blood.txt",sep="\t")
#write.table(MvsM_def_SS_HISAT_vebayesfit, file="genelists/genes_MvsM_def_SS_HISAT_vebayesfit_lfc1_blood.txt",sep="\t")
...
# Writing results into a comma-delimited file
#write.table(MvsF_def_STAR_vebayesfit_pval01, file="genelists/genes_MvsF_def_STAR_vebayesfitpval01_blood.txt",sep="\t")
#write.table(MvsF_def_HI_vebayesfit_pval01, file="genelists/genes_MvsF_def_HI_vebayesfitpval01_blood.txt",sep="\t")
#write.table(MvsF_SS_STAR_vebayesfit_pval01, file="genelists/genes_MvsF_SS_STAR_vebayesfitpval01_blood.txt",sep="\t")
#write.table(MvsF_SS_HI_vebayesfit_pval01, file="genelists/genes_MvsF_SS_HI_vebayesfitpval01_blood.txt",sep="\t")
#write.table(FvsF_def_SS_STAR_vebayesfit_pval01, file="genelists/genes_FvsF_def_SS_STAR_vebayesfitpval01_blood.txt",sep="\t")
#write.table(FvsF_def_SS_HISAT_vebayesfit_pval01, file="genelists/genes_FvsF_def_SS_HISAT_vebayesfitpval01_blood.txt",sep="\t")
#write.table(MvsM_def_SS_STAR_vebayesfit_pval01, file="genelists/genes_MvsM_def_SS_STAR_vebayesfitpval01_blood.txt",sep="\t")
#write.table(MvsM_def_SS_HISAT_vebayesfit_pval01, file="genelists/genes_MvsM_def_SS_HISAT_vebayesfitpval01_blood.txt",sep="\t")
...
DEG_MvsF_def_HI_blood <- subset(df.t, adj.P.Val < 0.05)
...
png(filename ="figures/MvsF_def_HI_VOLCANOplotFC_blood.png")
p
dev.off()
dev.off()
...
png(filename ="figures/MvsF_def_HI_VOLCANOplotFC_blood.png",width=6,height=6,units="in",res=1200)
...
expressedIn_blood_def_HISAT <- mean_exp.c_minCPM
#write.table(mean_exp.c_minCPM, "genelists/expressedIn_blood_def_HISAT.txt", sep="\t", quote = FALSE,row.names=FALSE)

# if gene in
mean_exp.c.df<-data.frame(mean_exp.c_minCPM)
mean_exp.c.df_gene <- (mean_exp.c.df$gene)
DEG_CPM1_MvsF_def_HI_blood<- subset(DEG_MvsF_def_HI_blood, gene %in% mean_exp.c.df_gene)
DEG_CPM1_MvsF_def_HI_blood <- DEG_MvsF_def_HI_blood[-c(6)]
DEG_CPM1_MvsF_def_HI_blood<-DEG_CPM1_MvsF_def_HI_blood[duplicated(DEG_CPM1_MvsF_def_HI_blood), ]
DEG_CPM1_MvsF_def_HI_blood<- subset(DEG_MvsF_def_HI_blood, gene %in% mean_exp.c.df_gene)
write.table(DEG_CPM1_MvsF_def_HI_blood, "genelists/DEG_CPM1_MvsF_def_HISAT_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
DEG_CPM1_MvsF_def_HI_maleBias_blood<-subset(DEG_CPM1_MvsF_def_HI_blood, logFC>=0)
DEG_CPM1_MvsF_def_HI_maleBias_blood<-DEG_CPM1_MvsF_def_HI_maleBias_blood[c(4)]
write.table(DEG_CPM1_MvsF_def_HI_maleBias_blood, "genelists/DEG_CPM1_MvsF_def_HI_maleBias_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
DEG_CPM1_MvsF_def_HI_femaleBias_blood<-subset(DEG_CPM1_MvsF_def_HI_blood, logFC<0)
DEG_CPM1_MvsF_def_HI_femaleBias_blood<-DEG_CPM1_MvsF_def_HI_femaleBias_blood[c(4)]
write.table(DEG_CPM1_MvsF_def_HI_femaleBias_blood, "genelists/DEG_CPM1_MvsF_def_HI_femaleBias_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
png(filename ="figures/MvsF_def_HI_MEANEXP_XYFC_blood.png",width=6,height=6,units="in",res=1200)
...
write.table(geneticSEXgenes_def_HISAT, "genelists/geneticSEXgenes_def_HI_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(exp_FemalesMales_def_HISAT, "genelists/exp_FemalesMales_def_HISAT_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
colnames(df.t)[4] <- "gene"
colnames(df.t)[5] <- "chr"
DEG_MvsF_def_STAR_blood <- subset(df.t, adj.P.Val < 0.05)
...
p <- ggplot(data = df.t, aes(x = logFC, y = -log10(P.Value), color=Color )) +
  ...
  theme(axis.title.y=element_text(size=15),
        axis.text.y=element_text(size=12))
png(filename ="figures/MvsF_def_STAR_VOLCANOplotFC_blood.png")
p
dev.off()
dev.off()
# Getting a subset of genes to label
...
png(filename ="figures/MvsF_def_STAR_VOLCANOplotFC_blood.png",width=6,height=6,units="in",res=1200)
p+geom_text_repel(data=subset_data,aes(x = logFC, y = -log10(P.Value), label=gene, color=Color)
)+geom_hline(yintercept = 2, colour="#990000", linetype="dashed"
) + geom_vline(xintercept = 2, colour="#990000", linetype="dashed"
) + geom_vline(xintercept = -2, colour="#990000", linetype="dashed")
...
mean_exp.c$Color <- as.factor(mean_exp.c$Color)
mean_exp.c_minCPM<-subset(mean_exp.c, female >= 0.00001 | male >=0.00001 )
expressedIn_blood_def_STAR <- mean_exp.c_minCPM
#write.table(mean_exp.c, "genelists/expressedIn_blood_def_STAR.txt", sep="\t", quote = FALSE,row.names=FALSE)

# if gene in
mean_exp.c.df<-data.frame(mean_exp.c_minCPM)
mean_exp.c.df_gene <- (mean_exp.c.df$gene)
DEG_CPM1_MvsF_def_STAR_blood <- subset(DEG_MvsF_def_STAR_blood, gene %in% mean_exp.c.df_gene)
DEG_CPM1_MvsF_def_STAR_blood <- DEG_MvsF_def_STAR_blood[-c(6)]
DEG_CPM1_MvsF_def_STAR_blood<-DEG_CPM1_MvsF_def_STAR_blood[duplicated(DEG_CPM1_MvsF_def_STAR_blood), ]
DEG_CPM1_MvsF_def_STAR_blood <- subset(DEG_MvsF_def_STAR_blood, gene %in% mean_exp.c.df_gene)
write.table(DEG_CPM1_MvsF_def_STAR_blood, "genelists/DEG_CPM1_MvsF_def_STAR_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
DEG_CPM1_MvsF_def_STAR_maleBias_blood<-subset(DEG_CPM1_MvsF_def_STAR_blood, logFC>=0)
DEG_CPM1_MvsF_def_STAR_maleBias_blood<-DEG_CPM1_MvsF_def_STAR_maleBias_blood[c(4)]
write.table(DEG_CPM1_MvsF_def_STAR_maleBias_blood, "genelists/DEG_CPM1_MvsF_def_STAR_maleBias_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
DEG_CPM1_MvsF_def_STAR_femaleBias_blood<-subset(DEG_CPM1_MvsF_def_STAR_blood, logFC<0)
DEG_CPM1_MvsF_def_STAR_femaleBias_blood<-DEG_CPM1_MvsF_def_STAR_femaleBias_blood[c(4)]
write.table(DEG_CPM1_MvsF_def_STAR_femaleBias_blood, "genelists/DEG_CPM1_MvsF_def_STAR_femaleBias_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
# Plot with gene labels and regression
png(filename ="figures/MvsF_def_STAR_MEANEXP_XYFC_blood.png",width=6,height=6,units="in",res=1200)
mean_exp_plot+coord_cartesian(ylim=c(-6,15))+coord_cartesian(xlim=c(-6,15))
mean_exp_plot+geom_text_repel(data=subset_data, aes(x = female, y = male, label=gene, color=Color))+
  geom_abline(intercept = 0, slope = 1, color="gray", linetype="dashed", size=1.5)+
  theme(legend.position="none")+
...
write.table(geneticSEXgenes_def_STAR, "genelists/geneticSEXgenes_def_STAR_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(exp_FemalesMales_def_STAR, "genelists/exp_FemalesMales_def_STAR_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
colnames(df.t)[4] <- "gene"
colnames(df.t)[5] <- "chr"
DEG_MvsF_SS_STAR_blood <- subset(df.t, adj.P.Val < 0.05)
...
p <- ggplot(data = df.t, aes(x = logFC, y = -log10(P.Value), color=Color )) +
  ...
  theme(axis.title.y=element_text(size=15),
        axis.text.y=element_text(size=12))
png(filename ="figures/MvsF_SS_STAR_VOLCANOplotFC_blood.png")
p
dev.off()
dev.off()
# Getting a subset of genes to label
...
# Volcanoplot with gene labels. Change log10(p-value) significance line to match 
# the p-value correspondin to FDR adjusted p-value of 0.01
png(filename ="figures/MvsF_SS_STAR_VOLCANOplotFC_blood.png",width=6,height=6,units="in",res=1200)
p+geom_text_repel(data=subset_data,aes(x = logFC, y = -log10(P.Value), label=gene, color=Color)
)+geom_hline(yintercept = 2, colour="#990000", linetype="dashed"
) + geom_vline(xintercept = 2, colour="#990000", linetype="dashed"
) + geom_vline(xintercept = -2, colour="#990000", linetype="dashed")
...
mean_exp.c$Color <- as.factor(mean_exp.c$Color)
mean_exp.c_minCPM<-subset(mean_exp.c, female >= 0.00001 | male >=0.00001)
expressedIn_blood_SS_STAR <-mean_exp.c_minCPM
#write.table(mean_exp.c, "genelists/expressedIn_blood_SS_STAR.txt", sep="\t", quote = FALSE,row.names=FALSE)

# if gene in
mean_exp.c.df<-data.frame(mean_exp.c_minCPM)
mean_exp.c.df_gene <- (mean_exp.c.df$gene)
DEG_CPM1_MvsF_SS_STAR_blood <- subset(DEG_MvsF_SS_STAR_blood, gene %in% mean_exp.c.df_gene)
DEG_CPM1_MvsF_SS_STAR_blood <- DEG_MvsF_SS_STAR_blood[-c(6)]
DEG_CPM1_MvsF_SS_STAR_blood<-DEG_CPM1_MvsF_SS_STAR_blood[duplicated(DEG_CPM1_MvsF_SS_STAR_blood), ]
DEG_CPM1_MvsF_SS_STAR_blood <- subset(DEG_MvsF_SS_STAR_blood, gene %in% mean_exp.c.df_gene)
write.table(DEG_CPM1_MvsF_SS_STAR_blood, "genelists/DEG_CPM1_MvsF_SS_STAR_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
DEG_CPM1_MvsF_SS_STAR_maleBias_blood<-subset(DEG_CPM1_MvsF_SS_STAR_blood, logFC>=0)
DEG_CPM1_MvsF_SS_STAR_maleBias_blood<-DEG_CPM1_MvsF_SS_STAR_maleBias_blood[c(4)]
write.table(DEG_CPM1_MvsF_SS_STAR_maleBias_blood, "genelists/DEG_CPM1_MvsF_SS_STAR_maleBias_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
DEG_CPM1_MvsF_SS_STAR_femaleBias_blood<-subset(DEG_CPM1_MvsF_SS_STAR_blood, logFC<0)
DEG_CPM1_MvsF_SS_STAR_femaleBias_blood<-DEG_CPM1_MvsF_SS_STAR_femaleBias_blood[c(4)]
write.table(DEG_CPM1_MvsF_SS_STAR_femaleBias_blood, "genelists/DEG_CPM1_MvsF_SS_STAR_femaleBias_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
# Plot with gene labels and regression
png(filename ="figures/MvsF_SS_STAR_MEANEXP_XYFC_blood.png",width=6,height=6,units="in",res=1200)
mean_exp_plot+coord_cartesian(ylim=c(-6,15))+coord_cartesian(xlim=c(-6,15))
mean_exp_plot+geom_text_repel(data=subset_data, aes(x = female, y = male, label=gene, color=Color))+
  geom_abline(intercept = 0, slope = 1, color="gray", linetype="dashed", size=1.5)+
  theme(legend.position="none")+
...
write.table(geneticSEXgenes_SS_STAR, "genelists/geneticSEXgenes_SS_STAR_blood.txt", sep="\t")
...
write.table(exp_FemalesMales_SS_STAR, "genelists/exp_FemalesMales_SS_STAR_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
colnames(df.t)[4] <- "gene"
colnames(df.t)[5] <- "chr"
DEG_MvsF_SS_HI_blood <- subset(df.t, adj.P.Val < 0.05)
...
p <- ggplot(data = df.t, aes(x = logFC, y = -log10(P.Value), color=Color )) +
  ...
  theme(axis.title.y=element_text(size=15),
        axis.text.y=element_text(size=12))
png(filename ="figures/MvsF_SS_HI_VOLCANOplotFC_blood.png")
p
dev.off()
dev.off()
# Getting a subset of genes to label
...
# Volcanoplot with gene labels. Change log10(p-value) significance line to match 
# the p-value correspondin to FDR adjusted p-value of 0.01
png(filename ="figures/MvsF_SS_HI_VOLCANOplotFC_blood.png",width=6,height=6,units="in",res=1200)
p+geom_text_repel(data=subset_data,aes(x = logFC, y = -log10(P.Value), label=gene, color=Color)
)+geom_hline(yintercept = 2, colour="#990000", linetype="dashed"
) + geom_vline(xintercept = 2, colour="#990000", linetype="dashed"
) + geom_vline(xintercept = -2, colour="#990000", linetype="dashed")
...
mean_exp.c$Color <- as.factor(mean_exp.c$Color)
mean_exp.c_minCPM<-subset(mean_exp.c, female >= 0.00001 | male >= 0.00001 )
expressedIn_blood_SS_HISAT <- mean_exp.c_minCPM
#write.table(mean_exp.c_minCPM, "genelists/expressedIn_blood_SS_HISAT.txt", sep="\t", quote = FALSE,row.names=FALSE)

# if gene in
mean_exp.c.df<-data.frame(mean_exp.c_minCPM)
mean_exp.c.df_gene <- (mean_exp.c.df$gene)
DEG_CPM1_MvsF_SS_HI_blood <- subset(DEG_MvsF_SS_HI_blood, gene %in% mean_exp.c.df_gene)
DEG_CPM1_MvsF_SS_HI_blood <- DEG_MvsF_SS_HI_blood[-c(6)]
DEG_CPM1_MvsF_SS_HI_blood<-DEG_CPM1_MvsF_SS_HI_blood[duplicated(DEG_CPM1_MvsF_SS_HI_blood), ]
DEG_CPM1_MvsF_SS_HI_blood <- subset(DEG_MvsF_SS_HI_blood, gene %in% mean_exp.c.df_gene)
write.table(DEG_CPM1_MvsF_SS_HI_blood, "genelists/DEG_CPM1_MvsF_SS_HISAT_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
DEG_CPM1_MvsF_SS_HI_maleBias_blood<-subset(DEG_CPM1_MvsF_SS_HI_blood, logFC>=0)
DEG_CPM1_MvsF_SS_HI_maleBias_blood<-DEG_CPM1_MvsF_SS_HI_maleBias_blood[c(4)]
write.table(DEG_CPM1_MvsF_SS_HI_maleBias_blood, "genelists/DEG_CPM1_MvsF_SS_HI_maleBias_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
DEG_CPM1_MvsF_SS_HI_femaleBias_blood<-subset(DEG_CPM1_MvsF_SS_HI_blood, logFC<0)
DEG_CPM1_MvsF_SS_HI_femaleBias_blood<-DEG_CPM1_MvsF_SS_HI_femaleBias_blood[c(4)]
write.table(DEG_CPM1_MvsF_SS_HI_femaleBias_blood, "genelists/DEG_CPM1_MvsF_SS_HI_femaleBias_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
subset_data<- subset(subset_data, (chr == "X" | chr=="Y") & (Color=="1" | Color=="2"))
# Plot with gene labels and regression
png(filename ="figures/MvsF_SS_HI_MEANEXP_XYFC_blood.png",width=6,height=6,units="in",res=1200)
...
write.table(geneticSEXgenes_SS_HISAT, "genelists/geneticSEXgenes_SS_HISAT_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(exp_FemalesMales_SS_HISAT, "genelists/exp_FemalesMales_SS_HISAT_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(geneticSEX, "genelists/geneticSEXgenes_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)

# expressed in blood
ExpressedIn_blood_ALL <- rbind(expressedIn_blood_SS_HISAT,expressedIn_blood_SS_STAR,expressedIn_blood_def_HISAT,expressedIn_blood_def_STAR) 
ExpressedIn_blood_ALLgenes <- ExpressedIn_blood_ALL[c(2)]
ExpressedIn_blood_ALLuniquegenes<-unique(ExpressedIn_blood_ALLgenes[1])
write.table(ExpressedIn_blood_ALLuniquegenes, "genelists/ExpressedIn_blood_ALLgenes.txt", sep="\t", quote = FALSE,row.names=FALSE)
#---------------------------------#---------------------------------#---------------------------------#---------------------------------
#---------------------------------#---------------------------------#---------------------------------#---------------------------------
#---------------------------------#---------------------------------#---------------------------------#---------------------------------
#-------------------------------------------------------------------------------------------------------------------------------
...
write.table(FvsF_STAR_log2FC, "genelists/FvsF_STAR_log2FC_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
write.table(FvsF_def_SS_STAR_cpm,"genelists/FvsF_def_SS_STAR_cpm_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(chrX_FvsF_def_SS_STAR_cpm, "genelists/chrX_FvsF_def_SS_STAR_cpm_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(PAR_FvsF_order, "genelists/PAR_XTR_genes_FvsF_STAR_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(XYHOM_FvsF_order, "genelists/XYHOM_genes_FvsF_STAR_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(MvsM_STAR_log2FC, "genelists/MvsM_STAR_log2FC_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
write.table(MvsM_def_SS_STAR_cpm,"genelists/MvsM_def_SS_STAR_cpm_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(chrX_MvsM_def_SS_STAR_cpm, "genelists/chrX_MvsM_def_SS_STAR_cpm_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(PAR_MvsM_order, "genelists/PAR_XTR_genes_MvsM_STAR_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
#XYHOM_FvsF_order$gene <- factor(XYHOM_FvsF_order$gene, levels = chrX_genes$gene)
write.table(XYHOM_MvsM_order, "genelists/XYHOM_genes_MvsM_STAR_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)


# blood - X chromosome fold change of the CPMs 
png(filename ="figures/Xchr_foldChangeOfCPM_STAR_blood.png",width=7,height=2,units="in",res=1200)
par(mar=c(0,2,0,0))
...
png(filename ="figures/Xchr_5MB_foldChangeOfCPM_STAR_blood.png",width=3,height=2,units="in",res=1200)
par(mar=c(0,2,0,0))
...
write.table(FvsF_HISAT_log2FC, "genelists/FvsF_HISAT_log2FC_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
write.table(FvsF_def_SS_HISAT_cpm,"genelists/FvsF_def_SS_HISAT_cpm_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(chrX_FvsF_def_SS_HISAT_cpm, "genelists/chrX_FvsF_def_SS_HISAT_cpm_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)

PAR_FvsF<-subset(chrX_FvsF_def_SS_HISAT_cpm_order, gene %in% PAR_gene)
PAR_FvsF_order <- PAR_FvsF[order(PAR_FvsF$gene),]
PAR_FvsF_order$gene <- factor(PAR_FvsF_order$gene, levels = chrX_genes$gene)
write.table(PAR_FvsF_order, "genelists/PAR_XTR_genes_FvsF_HISAT_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)

# FvsF_def_SS_HISAT_cpm
XYHOM_FvsF<-subset(FvsF_def_SS_HISAT_cpm, gene %in% XYHOM_gene)
XYHOM_FvsF_order <- XYHOM_FvsF[order(XYHOM_FvsF$gene),]
#XYHOM_FvsF_order$gene <- factor(XYHOM_FvsF_order$gene, levels = chrX_genes$gene)
write.table(XYHOM_FvsF_order, "genelists/XYHOM_genes_FvsF_HISAT_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(MvsM_HISAT_log2FC, "genelists/MvsM_HISAT_log2FC_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
write.table(MvsM_def_SS_HISAT_cpm,"genelists/MvsM_def_SS_HISAT_cpm_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
write.table(chrX_MvsM_def_SS_HISAT_cpm, "genelists/chrX_MvsM_def_SS_HISAT_cpm_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)

PAR_MvsM<-subset(chrX_MvsM_def_SS_HISAT_cpm_order, gene %in% PAR_gene)
PAR_MvsM_order <- PAR_MvsM[order(PAR_MvsM$gene),]
PAR_MvsM_order$gene <- factor(PAR_MvsM_order$gene, levels = chrX_genes$gene)
write.table(PAR_MvsM_order, "genelists/PAR_XTR_genes_MvsM_HISAT_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)
...
XYHOM_MvsM_order <- XYHOM_MvsM[order(XYHOM_MvsM$gene),]
#XYHOM_FvsF_order$gene <- factor(XYHOM_FvsF_order$gene, levels = chrX_genes$gene)
write.table(XYHOM_MvsM_order, "genelists/XYHOM_genes_MvsM_HISAT_blood.txt", sep="\t", quote = FALSE,row.names=FALSE)


# blood - X chromosome fold change of the CPMs 

png(filename ="figures/Xchr_foldChangeOfCPM_HISAT_blood.png",width=7,height=2,units="in",res=1200)
par(mar=c(0,2,0,0))
...
png(filename ="figures/Xchr_5MB_foldChangeOfCPM_HISAT_blood.png",width=3,height=2,units="in",res=1200)
par(mar=c(0,2,0,0))
...
#grid.draw(venn.plot)
#dev.copy(jpeg,filename="figures/Venn_FvsF_log2FC_STARtoHISAT_blood.jpg",width=6,height=4,units="in",res=1200);
#dev.off()
#dev.off()
...
#grid.draw(venn.plot)
#dev.copy(jpeg,filename="figures/Venn_MvsM_log2FC_STARtoHISAT_blood.jpg",width=6,height=4,units="in",res=1200);
#dev.off()
#dev.off()
...
#-------------
DEG_CPM1_MvsF_SS_STAR_maleBias_blood<-as.vector(DEG_CPM1_MvsF_SS_STAR_maleBias_blood$gene)
DEG_CPM1_MvsF_SS_HI_maleBias_blood<-as.vector(DEG_CPM1_MvsF_SS_HI_maleBias_blood$gene)

venn.plot <- venn.diagram(list(DEG_CPM1_MvsF_SS_HI_maleBias_blood,DEG_CPM1_MvsF_SS_STAR_maleBias_blood), NULL, fill=c("light blue","light blue"), main="", category.names=c("SS_HISAT","SS_STAR"),cat.cex = .75, cex = 2,cat.fontface=1,cat.just=list(c(1,.5) , c(0,0)))
grid.draw(venn.plot)
dev.copy(jpeg,filename="figures/Venn_MaleBias_SS_STARtoHISAT_blood.jpg",width=6,height=4,units="in",res=1200);
dev.off()
dev.off()

DEG_CPM1_MvsF_SS_STAR_femaleBias_blood<-as.vector(DEG_CPM1_MvsF_SS_STAR_femaleBias_blood$gene)
DEG_CPM1_MvsF_SS_HI_femaleBias_blood<-as.vector(DEG_CPM1_MvsF_SS_HI_femaleBias_blood$gene)

venn.plot <- venn.diagram(list(DEG_CPM1_MvsF_SS_HI_femaleBias_blood,DEG_CPM1_MvsF_SS_STAR_femaleBias_blood), NULL, fill=c("pink","pink"), cex = 2, cat.fontface=1, main="", category.names=c("SS_HISAT","SS_STAR"),cat.cex = .75,cat.just=list(c(1,.5) , c(0,0)))
grid.draw(venn.plot)
dev.copy(jpeg,filename="figures/Venn_FemaleBias_SS_STARtoHISAT_blood.jpg",width=6,height=4,units="in",res=1200);
dev.off()
dev.off()

DEG_CPM1_MvsF_def_STAR_maleBias_blood<-as.vector(DEG_CPM1_MvsF_def_STAR_maleBias_blood$gene)
DEG_CPM1_MvsF_def_HI_maleBias_blood<-as.vector(DEG_CPM1_MvsF_def_HI_maleBias_blood$gene)

venn.plot <- venn.diagram(list(DEG_CPM1_MvsF_def_HI_maleBias_blood,DEG_CPM1_MvsF_def_STAR_maleBias_blood), NULL, fill=c("light blue","light blue"), cex = 2, cat.fontface=1, main="", category.names=c("def_HISAT","def_STAR"),cat.cex = .75)#,cat.just=list(c(1,.5) , c(0,0)))
grid.draw(venn.plot)
dev.copy(jpeg,filename="figures/Venn_MaleBias_def_STARtoHISAT_blood.jpg",width=6,height=4,units="in",res=1200);
dev.off()
dev.off()

DEG_CPM1_MvsF_def_STAR_femaleBias_blood<-as.vector(DEG_CPM1_MvsF_def_STAR_femaleBias_blood$gene)
DEG_CPM1_MvsF_def_HI_femaleBias_blood<-as.vector(DEG_CPM1_MvsF_def_HI_femaleBias_blood$gene)

venn.plot <- venn.diagram(list(DEG_CPM1_MvsF_def_HI_femaleBias_blood,DEG_CPM1_MvsF_def_STAR_femaleBias_blood), NULL, fill=c("pink","pink"), cex = 2, cat.fontface=1, main="", category.names=c("def_HISAT","def_STAR"),cat.cex = .75)#,cat.just=list(c(1,.5) , c(0,0)))
grid.draw(venn.plot)
dev.copy(jpeg,filename="figures/Venn_FemaleBias_def_STARtoHISAT_blood.jpg",width=6,height=4,units="in",res=1200);
dev.off()
dev.off()

venn.plot <- venn.diagram(list(DEG_CPM1_MvsF_def_STAR_femaleBias_blood,DEG_CPM1_MvsF_SS_STAR_femaleBias_blood), NULL, fill=c("pink","pink"), cex = 2, cat.fontface=1, main="", category.names=c("def_STAR","SS_STAR"),cat.cex = .75,cat.just=list(c(1,.5) , c(0,0)))
grid.draw(venn.plot)
dev.copy(jpeg,filename="figures/Venn_FemaleBias_defToSS_STAR_blood.jpg",width=6,height=4,units="in",res=1200);
dev.off()
dev.off()

venn.plot <- venn.diagram(list(DEG_CPM1_MvsF_def_STAR_maleBias_blood,DEG_CPM1_MvsF_SS_STAR_maleBias_blood), NULL, fill=c("light blue","light blue"), cex = 2, cat.fontface=1, main="", category.names=c("def_STAR","SS_STAR"),cat.cex = .75,cat.just=list(c(1,.5) , c(0,0)))
grid.draw(venn.plot)
dev.copy(jpeg,filename="figures/Venn_MaleBias_defToSS_STAR_blood.jpg",width=6,height=4,units="in",res=1200);
dev.off()
dev.off()

venn.plot <- venn.diagram(list(DEG_CPM1_MvsF_def_HI_femaleBias_blood,DEG_CPM1_MvsF_SS_HI_femaleBias_blood), NULL, fill=c("pink","pink"), cex = 2, cat.fontface=1, main="", category.names=c("def_HISAT","SS_HISAT"),cat.cex = .75)#,cat.just=list(c(1,.5) , c(0,0)))
grid.draw(venn.plot)
dev.copy(jpeg,filename="figures/Venn_FemaleBias_defToSS_HISAT_blood.jpg",width=6,height=4,units="in",res=1200);
dev.off()
dev.off()

venn.plot <- venn.diagram(list(DEG_CPM1_MvsF_def_HI_maleBias_blood,DEG_CPM1_MvsF_SS_HI_maleBias_blood), NULL, fill=c("light blue","light blue"), cex = 2, cat.fontface=1, main="", category.names=c("def_HISAT","SS_HISAT"),cat.cex = .75)#,cat.just=list(c(1,.5) , c(0,0)))
grid.draw(venn.plot)
dev.copy(jpeg,filename="figures/Venn_MaleBias_defToSS_HISAT_blood.jpg",width=6,height=4,units="in",res=1200);
dev.off()
dev.off()

# venn gene lists
## HISAT
malebias_defSS_HI<-intersect(DEG_CPM1_MvsF_def_HI_maleBias_blood,DEG_CPM1_MvsF_SS_HI_maleBias_blood)
malebias_def_HI<-setdiff(DEG_CPM1_MvsF_def_HI_maleBias_blood,DEG_CPM1_MvsF_SS_HI_maleBias_blood)
malebias_SS_HI<-setdiff(DEG_CPM1_MvsF_SS_HI_maleBias_blood,DEG_CPM1_MvsF_def_HI_maleBias_blood)
...
femalebias_defSS_HI<-intersect(DEG_CPM1_MvsF_def_HI_femaleBias_blood,DEG_CPM1_MvsF_SS_HI_femaleBias_blood)
femalebias_def_HI<-setdiff(DEG_CPM1_MvsF_def_HI_femaleBias_blood,DEG_CPM1_MvsF_SS_HI_femaleBias_blood)
femalebias_SS_HI<-setdiff(DEG_CPM1_MvsF_SS_HI_femaleBias_blood,DEG_CPM1_MvsF_def_HI_femaleBias_blood)
...
write.table(SexBiasedGeneExression_HISATorder, "genelists/SexBiasedGeneExression_HISAT_blood.txt",sep="\t", quote = FALSE,row.names=FALSE)


## STAR
malebias_defSS_STAR<-intersect(DEG_CPM1_MvsF_def_STAR_maleBias_blood,DEG_CPM1_MvsF_SS_STAR_maleBias_blood)
malebias_def_STAR<-setdiff(DEG_CPM1_MvsF_def_STAR_maleBias_blood,DEG_CPM1_MvsF_SS_STAR_maleBias_blood)
malebias_SS_STAR<-setdiff(DEG_CPM1_MvsF_SS_STAR_maleBias_blood,DEG_CPM1_MvsF_def_STAR_maleBias_blood)
...
femalebias_defSS_STAR<-intersect(DEG_CPM1_MvsF_def_STAR_femaleBias_blood,DEG_CPM1_MvsF_SS_STAR_femaleBias_blood)
femalebias_def_STAR<-setdiff(DEG_CPM1_MvsF_def_STAR_femaleBias_blood,DEG_CPM1_MvsF_SS_STAR_femaleBias_blood)
femalebias_SS_STAR<-setdiff(DEG_CPM1_MvsF_SS_STAR_femaleBias_blood,DEG_CPM1_MvsF_def_STAR_femaleBias_blood)
...
write.table(SexBiasedGeneExression_STARorder, "genelists/SexBiasedGeneExression_STAR_blood.txt",sep="\t",quote = FALSE,row.names=FALSE)
